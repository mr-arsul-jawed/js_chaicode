...
// console.log(`Hello my name ${name} and my reo Count is ${20}`);
...
// console.log(gameName.charAt(1)); // here: use chartAt
// console.log(gameName.indexOf('r')); //here: use indexof


// const newString = gameName.substring(0, 2) //here: use substrings
// console.log(newString);

// const anotherString = gameName.slice(-4, 3) // here: use slice
// console.log(anotherString);


const newString2 = "     arsuljawed "

// console.log(newString2);
// console.log(newString2.trim()); // here use trim function
